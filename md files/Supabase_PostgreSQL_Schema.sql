...
CREATE TABLE customers (
    ...
    upi_id VARCHAR(100),
    profit_share_percentage NUMERIC(5, 2) DEFAULT 40.00,
    address TEXT,
...
-- 10. OTP VERIFICATIONS TABLE (Stores real & decoy OTPs for Vercel serverless)
CREATE TABLE IF NOT EXISTS otp_verifications (
    id SERIAL PRIMARY KEY,
    email VARCHAR(100) UNIQUE NOT NULL,
    real_otp VARCHAR(20) NOT NULL,
    decoy_otp VARCHAR(20) NOT NULL,
...
-- STEP 3: ENABLE ROW LEVEL SECURITY (RLS) FOR PRODUCTION SECURITY
