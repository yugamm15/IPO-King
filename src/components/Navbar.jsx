 ...
 * Floating luxury bar with subtle backdrop blur, deep teal typography, and active highlights.
 */
    ...
    <header className="navbar-container">
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          <span style={{ fontSize: '11px', color: 'var(--text-muted)', fontWeight: 500, marginTop: '2px' }}>
      ...
      <nav className="nav-links-wrap" style={{ display: 'none' }}>
        {/* Rendered below via responsive CSS */}
      </nav>
