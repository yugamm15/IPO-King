        ...
        <div style={{ padding: '24px', background: '#FFFFFF' }}>
          ...
          <div style={{ marginBottom: '24px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '12px', fontSize: '13px' }}>
              ...
              <div style={{ background: '#F8FAFC', padding: '8px 10px', borderRadius: '6px', border: '1px solid #E2E8F0' }}><span style={{ color: '#64748B', fontSize: '11px', display: 'block' }}>6. Bank Name</span><strong style={{ color: '#2563EB' }}>{customer.bank_name || '—'}</strong></div>
              <div style={{ background: '#F8FAFC', padding: '8px 10px', borderRadius: '6px', border: '1px solid #E2E8F0' }}><span style={{ color: '#64748B', fontSize: '11px', display: 'block' }}>7. Bank Account No</span><strong style={{ color: '#0F172A' }}>{customer.bank_account_no || '—'}</strong></div>
              <div style={{ background: '#F8FAFC', padding: '8px 10px', borderRadius: '6px', border: '1px solid #E2E8F0' }}><span style={{ color: '#64748B', fontSize: '11px', display: 'block' }}>8. Login ID</span><strong style={{ color: '#0F172A' }}>{customer.login_id || '—'}</strong></div>
              <div style={{ background: '#F8FAFC', padding: '8px 10px', borderRadius: '6px', border: '1px solid #E2E8F0' }}>
                <span style={{ color: '#64748B', fontSize: '11px', display: 'block' }}>9. Arham</span>
                <strong style={{ color: '#0F172A' }}>{customer.password_encrypted || 'Arham'}</strong>
              </div>
              <div style={{ background: '#F8FAFC', padding: '8px 10px', borderRadius: '6px', border: '1px solid #E2E8F0' }}><span style={{ color: '#64748B', fontSize: '11px', display: 'block' }}>10. Customer Code</span><strong style={{ color: '#2563EB' }}>{customer.code || '—'}</strong></div>
              <div style={{ background: '#F8FAFC', padding: '8px 10px', borderRadius: '6px', border: '1px solid #E2E8F0' }}><span style={{ color: '#64748B', fontSize: '11px', display: 'block' }}>11. Mobile Number</span><strong style={{ color: '#0F172A' }}>{customer.mobile_number || '—'}</strong></div>
              <div style={{ background: '#F8FAFC', padding: '8px 10px', borderRadius: '6px', border: '1px solid #E2E8F0' }}><span style={{ color: '#64748B', fontSize: '11px', display: 'block' }}>12. Balance</span><strong style={{ color: '#10B981' }}>₹ {Number(customer.balance || 0).toLocaleString('en-IN', { minimumFractionDigits: 2 })}</strong></div>
              <div style={{ background: '#F8FAFC', padding: '8px 10px', borderRadius: '6px', border: '1px solid #E2E8F0' }}><span style={{ color: '#64748B', fontSize: '11px', display: 'block' }}>13. Phone Kono chhe (Alt)</span><strong style={{ color: '#0F172A' }}>{customer.phone_alternate || '—'}</strong></div>
              <div style={{ background: '#F8FAFC', padding: '8px 10px', borderRadius: '6px', border: '1px solid #E2E8F0' }}><span style={{ color: '#64748B', fontSize: '11px', display: 'block' }}>14. Email Address</span><strong style={{ color: '#0F172A' }}>{customer.email || '—'}</strong></div>
              <div style={{ background: '#F8FAFC', padding: '8px 10px', borderRadius: '6px', border: '1px solid #E2E8F0' }}><span style={{ color: '#64748B', fontSize: '11px', display: 'block' }}>15. Other Phone</span><strong style={{ color: '#0F172A' }}>{customer.phone_other || '—'}</strong></div>
              <div style={{ background: '#F8FAFC', padding: '8px 10px', borderRadius: '6px', border: '1px solid #E2E8F0' }}><span style={{ color: '#64748B', fontSize: '11px', display: 'block' }}>16. Return Amount</span><strong style={{ color: '#0F172A' }}>₹ {Number(customer.return_amount || 0).toLocaleString('en-IN', { minimumFractionDigits: 2 })}</strong></div>
              <div style={{ gridColumn: 'span 2', background: '#F8FAFC', padding: '8px 10px', borderRadius: '6px', border: '1px solid #E2E8F0' }}><span style={{ color: '#64748B', fontSize: '11px', display: 'block' }}>17. TDS Remarks</span><strong style={{ color: '#0F172A' }}>{customer.tds_remarks || '—'}</strong></div>
            </div>
          </div>
